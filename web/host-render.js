...
window.__host = window.__host || {};
  ...
  // links, karierte Fläche mit gezacktem (flatterndem) rechten Rand.
  const ICON_ACTION_CHECK = '<svg class="ico ico-lg" viewBox="0 0 24 24" fill="currentColor"><rect x="4" y="2" width="1.6" height="20" rx="0.8"/><rect x="5" y="3" width="3.5" height="2.67"/><rect x="12" y="3" width="3.5" height="2.67"/><rect x="8.5" y="5.67" width="3.5" height="2.67"/><rect x="15.5" y="5.67" width="3.5" height="2.67"/><rect x="5" y="8.33" width="3.5" height="2.67"/><rect x="12" y="8.33" width="3.5" height="2.67"/><polygon points="15.5,8.33 17,8.33 17.85,9.67 17,11 15.5,11"/><path d="M5 3 H19 L17 5 L19 7 L17 9 L19 11 H5 Z" fill="none" stroke="currentColor" stroke-width="0.9" stroke-linejoin="round"/></svg>';
  ...
  const ICON_DISCONNECT = '<svg class="ico ico-lg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M11 7H8a3 3 0 0 0-3 3v4a3 3 0 0 0 3 3h3"/><path d="M13 7h3a3 3 0 0 1 3 3v4a3 3 0 0 1-3 3h-3"/><path d="M4.2 20.5 19.8 3.5" stroke-width="2.7"/><path d="M12 1.3v3.2M8.4 2.7 6.1 5.1M15.6 2.7l2.3 2.4" stroke-width="1.15"/><path d="M12 19.5v3.2M8.4 21.3l-2.3 2.4M15.6 21.3l2.3 2.4" stroke-width="1.15"/><circle cx="12" cy="12" r="1.15" fill="currentColor" stroke="none"/></svg>';
